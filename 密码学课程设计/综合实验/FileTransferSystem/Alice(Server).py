...
import rsa as RSA
##########################################################################################
SERVER_WORKDIR = "D:\\Course\\密码学课程设计\\综合实验\\FileTransferSystem\\ServerData\\"
SERVER_PUB_PATH = "D:\\Course\\密码学课程设计\\综合实验\\FileTransferSystem\\ServerKeys\\server.pub"
SERVER_KEY_PATH = "D:\\Course\\密码学课程设计\\综合实验\\FileTransferSystem\\ServerKeys\\server.key"
CLIENT_PUB_PATH = "D:\\Course\\密码学课程设计\\综合实验\\FileTransferSystem\\ServerKeys\\client.pub"
MAXBUFFSIZE = 51200
BUFFSIZE = 20480
...
def file_decrypt(encrypted_filepath, key_encrypted, iv_encrypted):
    ...
    key = RSA.decrypt(key_encrypted, server_d, server_d)
    iv = RSA.decrypt(iv_encrypted, server_d, server_d)
    # 打开并读取加密文件
...
[+] exit -----------------------------close socket and exit'''
        ...
        while True:
            ...
            elif recv_cmd_list[0] == 'get' and len(recv_cmd_list) == 2:
